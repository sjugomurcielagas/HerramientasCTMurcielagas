...
Abrir `/` desde la computadora o desde un teléfono conectado a la misma red. El
servidor expone solamente esta carpeta en la red local y debe apagarse al terminar
la prueba.
...
- Ver rutina y Paso a paso con controles Anterior, Repetir y Siguiente.
